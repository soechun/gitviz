...
var z = d3.scaleOrdinal()
    .range(["#55efc4","#81ecec","#74b9ff","#a29bfe","#dfe6e9","#00b894","#00cec9","#0984e3","#6c5ce7","#b2bec3","#ffeaa7","#fab1a0","#ff7675","#fd79a8","#636e72","#fdcb6e","#e17055","#d63031","#e84393","#2d3436","#f3a683","#f19066","#786fa6","#574b90","#f8a5c2","#f78fb3","#63cdda","#3dc1d3","#ea8685","#e66767","#f7d794","#f5cd79","#778beb","#546de5"]);
...
function processLanguages(result) {
    ...
    var temp = [];
        for(var i=0; i < result.length; i++) {
            ...
            var tempset = {};
            tempset['repo']=item.name;
            for(var key in languages) {
                repoSet.add(item.name);
                langSet.add(key);
                tempset[key] = languages[key];
                // temp.push({
                //     repo: item.name,
                //     langugae: key,
                //     bytes: languages[key]
            ...
            temp.push(tempset);
            temp['repoSet']=repoSet;
            temp['langSet']=langSet;
        }
    return temp
}
